...
def collate_fn(batch: tuple):
    """Custom collate function of train dataloader for Img2Gene.   
    ...
    pathway = torch.stack([item[8] for item in batch])
    return patch, exp, pid, sid, wsi, position, neighbors, mask, pathway
...
def load_config(config_name: str):
    ...
    """
    config_path = os.path.join('/home/wzhang/img2gene/config', f'{config_name}.yaml')
...
def load_loggers(cfg: Dict):
    ...
    log_path = os.path.join(cfg.GENERAL.log_path, cfg.GENERAL.model_name)
